...
insert into public.locations (id, name, description, background_image, map_x, map_y, region_kind, is_implemented, unlock_hint, sort_order) values
  ...
  ('mountains', 'Frost Mountains', 'A high, frozen range riddled with old mine shafts. Something ancient sleeps beneath the ice.', '/assets/locations/mountains.png', 92, 14, 'wilderness', false, 'The mountain paths are lost in fog.', 6),
